...
CREATE TABLE BOOK_LOANS (book_id INT NOT NULL, branch_id INT NOT NULL, card_no INT NOT NULL, date_out DATE NOT NULL, due_date DATE NOT NULL,returned_date DATE NOT NULL ,PRIMARY KEY (book_id, card_no), FOREIGN KEY (book_id) REFERENCES BOOK(book_id), FOREIGN KEY (card_no) REFERENCES BORROWERS (card_no), FOREIGN KEY (branch_id) REFERENCES LIBRARY_BRANCH (branch_id));
